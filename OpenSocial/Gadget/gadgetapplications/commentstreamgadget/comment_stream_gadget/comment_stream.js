  ...
  return {
    init: function() {
    	...
    	function clearDrafts() {
    		// Initializes 'drafts' for the current user in the private state object (wave).
    	...
    	function editDraft(draft) {
	    	...
	    	// Updates 'drafts' with 'updatedDrafts' for the current user in the private state object (wave)
