...
try
{
	...
	HttpPost jamRequest = new HttpPost("api/v1/OData/Members('" + memberID + "')/$links/Following");
	...
	String jsonToSend = "";
	jsonToSend += "{";
	//If you want to use the fully qualified URL, however the relative url is supported
	//jsonToSend += "\"uri\" : \"https://developer.sapjam.com/api/v1/OData/Members('" + followerID + "')\"";
